...
see v1.31b/docs/06-transcription.md.  Turbo Pascal 7's built-in assembler is
...
def main():
    ...
    w = out.append
    w("{ ==========================================================================")
    w("  GENERATED by v1.31b/emit_gain.py -- DO NOT EDIT.")
    w("")
    w("  DemoVT v1.31 (beta) -- (C) 1992-93 VangeliSTeam (JCAB).")
    w("  NOT Asphyxia code. See v1.31b/docs/00-map.md.")
    w("")
